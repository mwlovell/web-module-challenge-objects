...
console.log(createMenuItem('sammy', 10, 'brunch'));
console.log(createMenuItem('soup', 6, 'drinks'));
...
function addReview(name, rating, review){
  return reviews.push('Daniela', 5, 'Beautiful atmosphere and wonderful vegan options!');
  }
console.log()
